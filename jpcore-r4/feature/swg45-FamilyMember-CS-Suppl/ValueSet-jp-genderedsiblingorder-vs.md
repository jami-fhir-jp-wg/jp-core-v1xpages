...
* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/ValueSet/JP_GenderedSiblingOrder_VS
* **項目**: *Version*
  * **内容**: 1.3.0-dev
* **項目**: *Name*
  * **内容**: JP_GenderedSiblingOrder_VS
* **項目**: *Title*
...
性別の同胞内出生順を表すValueSet。JP_GenderedSiblingOrder_CS を包含。 
...
```json
{
  ...
  "version" : "1.3.0-dev",
  "name" : "JP_GenderedSiblingOrder_VS",
