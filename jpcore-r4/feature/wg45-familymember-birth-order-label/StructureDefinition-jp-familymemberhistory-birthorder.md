# JP Core FamilyMemberHistory Birth Order Extension - HL7 FHIR JP Core ImplementationGuide v1.3.0-dev

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **JP Core FamilyMemberHistory Birth Order Extension**

## Extension: JP Core FamilyMemberHistory Birth Order Extension 

* **項目**: *定義URL*
  * **内容**: http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_FamilyMemberHistory_BirthOrder
* **項目**: *Version*
  * **内容**: 1.3.0-dev
* **項目**: *Name*
  * **内容**: JP_FamilyMemberHistory_BirthOrder
* **項目**: *Title*
  * **内容**: JP Core FamilyMemberHistory Birth Order Extension
* **項目**: *Status*
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/jpfhir.jp.core|current/StructureDefinition/jp-familymemberhistory-birthorder)
...
Other representations of profile: [CSV](StructureDefinition-jp-familymemberhistory-birthorder.csv), [Excel](StructureDefinition-jp-familymemberhistory-birthorder.xlsx), [Schematron](StructureDefinition-jp-familymemberhistory-birthorder.sch) 
...
```json
{
  ...
  "version" : "1.3.0-dev",
  "name" : "JP_FamilyMemberHistory_BirthOrder",
  ...
  "differential" : {
    "element" : [
      ...
      },
      {
        "id" : "Extension.url",
        "path" : "Extension.url",
        "fixedUri" : "http://jpfhir.jp/fhir/core/Extension/StructureDefinition/JP_FamilyMemberHistory_BirthOrder"
      },
      {
        ...
        "binding" : {
          "strength" : "preferred",
          "valueSet" : "http://jpfhir.jp/fhir/core/ValueSet/JP_BirthOrder_VS"
        }
      }
    ]
  }
