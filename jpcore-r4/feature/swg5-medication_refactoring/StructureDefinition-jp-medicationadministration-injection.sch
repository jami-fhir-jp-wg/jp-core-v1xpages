...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].extension 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both (inherited)</sch:assert>
  ...
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="not(exists(f:code)) or exists(f:system)">If a code for the unit is present, the system SHALL also be present (inherited)</sch:assert>
    </sch:rule>
  ...
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator.extension 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator.value 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator.comparator 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator/f:comparator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator.unit 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator/f:unit">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator.system 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].numerator.code 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:numerator/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator.extension 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator/f:extension">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children</sch:assert>
      <sch:assert test="exists(f:extension)!=exists(f:*[starts-with(local-name(.), &quot;value&quot;)])">Must have either extensions or value[x], not both</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator.value 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator.comparator 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator/f:comparator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator.unit 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator/f:unit">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator.system 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].denominator.code 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:denominator/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
  ...
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].value 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:value">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].comparator 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:comparator">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].unit 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:unit">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].system 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:system">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:title>MedicationAdministration.dosage.rate[x].code 1</sch:title>
    <sch:rule context="f:MedicationAdministration/f:dosage/f:rate[x]/f:code">
      <sch:assert test="@value|f:*|h:div">All FHIR elements must have a @value or children (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
