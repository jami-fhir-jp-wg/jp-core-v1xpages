...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <!-- 
    This file contains just the constraints for the profile JP_MedicationAdministration
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:MedicationAdministration/f:dosage">
      <sch:assert test="@value|f:*|h:div">すべてのFHIR要素には、@valueまたは子供が必要です / All FHIR elements must have a @value or children (inherited)</sch:assert>
      <sch:assert test="exists(f:dose) or exists(f:*[starts-with(local-name(.), 'rate')])">Dosage.DoseまたはDosage.Rate [x]の少なくとも1つがあります。 / SHALL have at least one of dosage.dose or dosage.rate[x] (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
