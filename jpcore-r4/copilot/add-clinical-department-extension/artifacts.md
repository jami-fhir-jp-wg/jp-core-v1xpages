...
| [JP Core Organization Department Profile](StructureDefinition-jp-organization-department.md) | このプロファイルはJP_Organizationリソースに対して、診療科情報のデータを送受信するための制約と拡張を定めたものである。診療科を表すOrganizationとして利用することを想定している。 |
...
| [JP Core Organization Department Example 内科診療科](Organization-jp-organization-department-example-01.md) | JP_Organization_Departmentリソースの例。内科診療科を表すOrganization例 |
| [JP Core Organization Department Example 整形外科診療科](Organization-jp-organization-department-example-02.md) | JP_Organization_Departmentリソースの例。整形外科診療科を表すOrganization例 |
